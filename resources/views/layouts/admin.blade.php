            ...
            <div class="h-full flex flex-col">
                ...
                <nav class="flex-1 overflow-y-auto py-4">
                    <ul class="space-y-1">
                        ...
                        <li class="pt-4">
                            <span class="px-4 text-xs font-semibold text-gray-500 uppercase">Customer Management</span>
                        </li>

                        <li>
                            <a href="{{ route('admin.customers.index') }}" class="flex items-center px-4 py-3 hover:bg-gray-800 {{ request()->routeIs('admin.customers.*') ? 'bg-gray-800 border-l-4 border-emerald-500' : '' }}">
                                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"/></svg>
                                Customers
                            </a>
                        </li>
                        ...
                        <li class="pt-4">
                            <span class="px-4 text-xs font-semibold text-gray-500 uppercase">Admin Management</span>
                        </li>
