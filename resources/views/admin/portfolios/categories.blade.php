                ...
                @forelse($categories as $category)
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            ...
                            <form action="{{ route('admin.portfolios.categories.destroy', $category) }}" method="POST" class="inline" onsubmit="return confirm('Delete this category?')">
                                @csrf
                                @method('DELETE')
...
<script>
    function openModal() {
        ...
        document.getElementById('category-form').action = '{{ route('admin.portfolios.categories.store') }}';
    ...
    function editCategory(category) {
        ...
        document.getElementById('category-form').action = `/admin/portfolio-categories/${category.id}`;
