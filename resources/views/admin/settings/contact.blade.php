        ...
        <form action="{{ route('admin.settings.contact.update') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    ...
                    <input type="email" name="contact_email" value="{{ \App\Models\SiteSetting::get('contact_email') }}"
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                </div>

                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Phone Number</label>
                    <input type="text" name="contact_phone" value="{{ \App\Models\SiteSetting::get('contact_phone') }}"
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                </div>

                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">WhatsApp Number</label>
                    <input type="text" name="whatsapp" value="{{ \App\Models\SiteSetting::get('whatsapp') }}" placeholder="+1234567890"
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                ...
                <div>
                    ...
                    <input type="email" name="support_email" value="{{ \App\Models\SiteSetting::get('support_email') }}"
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                </div>
            </div>
            ...
            <div class="mb-6">
                ...
                <textarea name="contact_address" rows="3" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">{{ \App\Models\SiteSetting::get('contact_address') }}</textarea>
            </div>

            <div class="mb-6">
                <label class="block text-sm font-medium text-gray-700 mb-2">Google Maps Embed URL</label>
                <input type="url" name="google_maps_url" value="{{ \App\Models\SiteSetting::get('google_maps_url') }}"
                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
